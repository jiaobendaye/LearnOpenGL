...
void AtmosphereDefalut(Shader& lightingShader);
void AtmosphereDesert(Shader& lightingShader);
void AtmosphereFactory(Shader& lightingShader);
...
glm::vec3 pointLightColorsDesert[] = {
...
glm::vec3 pointLightColorsFactory[] = {
...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("resources/shaders/lighting_maps.vs", "resources/shaders/multiple_lights.fs");
    Shader lightCubeShader("resources/shaders/coordinate_system.vs", "resources/shaders/light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        AtmosphereFactory(lightingShader);
        auto& pointLightColors = pointLightColorsFactory;
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
         ...
         for (unsigned int i = 0; i < 4; i++)
         {
            ...
            lightCubeShader.setVec3("lightColor", pointLightColors[i].x, pointLightColors[i].y, pointLightColors[i].z);
            glDrawArrays(GL_TRIANGLES, 0, 36);
         }
...
void SetPointLight(Shader& lightingShader, const glm::vec3 pointLightColors[4])
{
    // Point light 1
...
void AtmosphereDesert(Shader& lightingShader)
{
    ...
    // Point light
    SetPointLight(lightingShader, pointLightColorsDesert);
...
void AtmosphereFactory(Shader& lightingShader)
{
    ...
    // Point light
    SetPointLight(lightingShader, pointLightColorsFactory);
